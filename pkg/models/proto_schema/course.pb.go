...
type CoursesID struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CoursesID []string `protobuf:"bytes,1,rep,name=coursesID,proto3" json:"coursesID,omitempty"`
}

func (x *CoursesID) Reset() {
	*x = CoursesID{}
	if protoimpl.UnsafeEnabled {
...
func (x *CoursesID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CoursesID) ProtoMessage() {}

func (x *CoursesID) ProtoReflect() protoreflect.Message {
	mi := &file_course_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CoursesID.ProtoReflect.Descriptor instead.
func (*CoursesID) Descriptor() ([]byte, []int) {
	return file_course_proto_rawDescGZIP(), []int{2}
}

func (x *CoursesID) GetCoursesID() []string {
	if x != nil {
		return x.CoursesID
	}
	return nil
...
var file_course_proto_rawDesc = []byte{
	...
	,
...
var file_course_proto_goTypes = []interface{}{
	(*Course)(nil),    // 0: model.Course
	(*Courses)(nil),   // 1: model.Courses
	(*CoursesID)(nil), // 2: model.CoursesID
}
var file_course_proto_depIdxs = []int32{
	0, // 0: model.Courses.list:type_name -> model.Course
	2, // 1: model.CoursesService.List:input_type -> model.CoursesID
	1, // 2: model.CoursesService.List:output_type -> model.Courses
